...
class NoxenApp(App):
        ...
        with TabbedContent(id="main_tabs"):
            ...
            with TabPane(" Discovery ", id="tab_discovery"):
                with VerticalScroll(id="discovery_pane"):
                    ...
                    yield Rule()
                    with Horizontal(classes="connect_row"):
                        yield Label("Prefixes", classes="connect_label")
                        yield Input(
                            id="discovery_prefixes",
                            value="com.kony.crypto,com.xd,com.vasco.digipass.sdk.utils.devicebinding",
                            placeholder="comma-separated class prefixes",
                            select_on_focus=False,
                        )
                    with Horizontal(classes="connect_row"):
                        ...
                        yield Input(
                            ...
                            value="encrypt,decrypt,crypto,cipher,aes,sign,verify,key,keystore,token,otp,pin,devicebinding,fingerprint,salt",
    ...
    def _render_discovery_results(self, result: dict):
        ...
        try:
            ...
            out.write("[dim]Only targeted prefixes are scanned to avoid app crashes.[/dim]")
            out.write("")
